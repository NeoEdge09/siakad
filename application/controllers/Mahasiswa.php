...
class Mahasiswa extends CI_Controller {
	...
	public function pdf1(){
        ...
        foreach ($mahasiswa as $data) {
            ...
            $pdf->Cell(30, 10, $data->nim, 1, 0, 'C');
            $pdf->Cell(50, 10, $data->tgl_lahir, 1, 0, 'C');
            $pdf->Cell(50, 10, $data->jurusan, 1, 1, 'C');
        }
        $pdf->Output();
	}
	public function exportExcel(){
		...
		header('Content-disposition: attachment; filename="'.XLSXWriter::
		...
		$styles2 = array (['font'=>'Arial','font-size'=>10,'font-style'=>'bold','fill'=>'#eee','halign'=>'left','border'=>'left,right,top,bottom', 'fill'=>'#ffc'], ['fill'=>'#fcf'], ['fill'=>'#ccf'], ['fill'=>'#ccf'], ['fill' => '#ccf']);
